        ...
        <div class="card shadow">
            ...
            while($data = mysqli_fetch_assoc($result) ) { ?>
                <div class="row" style="padding:5px;">
                    ...
                    <div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
                        <button style="float:left;margin-right:10px; margin-left:15%;" class="btn btn-success" type="submit"><a href="updatedata.php?nim=<?= $data["nim"];?>" class="text-white"><i class="fa fa-edit fa-md"></i></a></button>
                        <button style="float:left" class="btn btn-danger" type="submit"><a href="deletedata.php?nim=<?= $data["nim"]; ?>" class="text-white"><i class="fa fa-trash fa-md"></i></a></button>
                    </div>
                </div>
            <?php } ?>
        </div>
